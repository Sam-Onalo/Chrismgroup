<x-frontend-layout>
    @section('page-title', 'Oil Services')
    ...
    @push('styles')
        <style>
            ...
            .page_title {
                background-image: url("{{ asset('frontend/images/custom/oil_banner.jpg') }}");
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-10 offset-xl-1">
                    <img class="rounded" src="{{ asset('frontend/images/custom/oil.jpg') }}" alt="">
                    ...
                    <p>
                        Chrism Oil Nigeria Limited is a subsidiary of the Chrism Group of companies. The company company was incorporated in Nigeria in 2015 under the Company and Allied Matters Act of 2004 and handles the marketing, haulage and sales of all refined, non-gaseous, petroleum products such as Premium Motor Spirit (PMS), Dual Purpose Kerosene (DPK) , Auto Gas Oil (AGO), Grease, Lubricants, Hydraulics, and fuel treatments etc.
                        <br> The organisation builds, and maintains petrol service station across Nigeria.
                    </p>
                    <div class="divider-60 hidden-below-lg"></div>
                    <div class="divider-30 hidden-above-lg"></div>
                </div>
                            ...
                            <div class="card__body">
                                ...
                                <header class="card__body-header">
                                    ...
                                    <address>
                                        ...
                                        Uyo-Oron Rd (Airport Rd) Mbiabong Ikot Essien, <br>
                                        Uyo LGA,
                                        Akwa Ibom State, <br>
                                        Nigeria
                                    </address>
